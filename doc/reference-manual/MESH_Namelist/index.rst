...
.. csv-table:: 
   ...
   "**chaco**","uses a graph partitioning method from the Chaco library :footcite:`leland1995chaco` to compute the mesh decomposition at run time. This is the standard method long used by Truchas."
