...
class CapabilityTest(TruchasCapabilityTest):
	...
	if 'parallel' in self.basicrunspecs.parallel_env:
            self.tol['error'] = 1e-03
            self.tol['Herror'] = 1e-03
        else:
            self.tol['error'] = 1e-08
            self.tol['Herror'] = 1.0e-06
    ...
    def setDataStores(self):
        ...
        self.testdirs = ['phasechange_eutectic_output']
        self.goldendirs = ['phasechange_eutectic_golden']
