...
-----------------------------------------------------------------------------
   ...
   Public Interface:
      ...
      T = MyAbortLoader(dir,norerun,parallel_env,np,
                   compiler,compile_mode,truchas_bin,
                   truchas_exe)
      T.getSuite()
  
   Contains: MyAbortLoader
...
from Loaders               import RunLoader, ModuleLoader, PPLoader, PPVisualisationLoader
from Interrogators         import DirectoryInterrogator

class MyAbortLoader(unittest.TestLoader):
    """
