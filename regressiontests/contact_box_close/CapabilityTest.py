...
class CapabilityTest(TruchasCapabilityTest):
    ...
    def setDataStores(self):
        ...
        self.testdirs    = ['contact_box_close_output']
        self.goldendirs  = ['contact_box_close_golden']
    ...
    def testOpenStress(self):
        ...
        self.logger.write("Comparing stresses to reference just before gap closing ...\n")
        n = 15
    ...
    def testOpenStrain(self):
        ...
        self.logger.write("Comparing strains to reference just before gap closing ...\n")
        n = 15
        tol = 2.0e-8
    ...
    def testOpenNormalTraction(self):
        "Verifying normal traction just before closing"
        self.logger.write("Comparing initial normal traction to exact ...\n")
        n = 15
        tol = 1.0e-4
        exact = 0.0
    ...
    def testClosedStress(self):
        ...
        self.logger.write("Comparing stresses to reference just after gap closing ...\n")
        n = 18
        tol = 1.0e4 # sloppy
        sigma = self.testdata[0].getField(field='sigma', cycle=n, region=self.whole_mesh)
        sigma_ref = self.goldendata[0].getField(field='sigma', cycle=n, region=self.whole_mesh)
    ...
    def testClosedStrain(self):
        ...
        self.logger.write("Comparing strains to reference just after gap closing ...\n")
        n = 18
        tol = 2.0e-8
        eps = self.testdata[0].getField(field='epsilon', cycle=n, region=self.whole_mesh)
        eps_ref = self.goldendata[0].getField(field='epsilon', cycle=n, region=self.whole_mesh)
    ...
    def testClosedDisplacement(self):
        ...
        self.logger.write("Comparing displacement magnitude to reference just after gap closing ...\n")
    ...
    def testClosedTemperature(self):
        ...
        self.logger.write("Comparing temperature to reference just after gap closing ...\n")
        n = 18
        tol = 1.0e-5
    ...
    def testFinalNormalTraction(self):
        ...
        self.logger.write("Comparing final normal traction to exact steady state ...\n")
        n = 42
        tol = 1.0e-6
        exact = -2.288e7
        ntrac = self.testdata[0].getField(field='NTRAC_02', cycle=n, region=self.gap)
