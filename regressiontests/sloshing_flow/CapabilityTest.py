...
class CapabilityTest(TruchasCapabilityTest):
  ...
  def testFinalSolidVolumeFraction(self):
    ...
    tol = 1.0e-6
    n = 92 # should be the final cycle time

    self.logger.write("Verifying the final fluid volume fraction field...\n")
