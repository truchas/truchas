...
module HT_2d_ic_solver_type
  ...
  contains
    procedure :: init
    procedure, private :: compute_array
    procedure, private :: compute_vector
...
contains
  ...
  subroutine compute_array(this, t, dt, temp, u, udot, rel_tol, max_itr, stat, errmsg)
  ...
  !! The packed-array implementation is retained above only for the legacy
  !! unit test interface.
