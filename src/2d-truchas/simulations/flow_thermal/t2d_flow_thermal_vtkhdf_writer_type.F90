!!
!! T2D_FLOW_THERMAL_VTKHDF_WRITER_TYPE
!!
!! This module defines T2D_FLOW_THERMAL_VTKHDF_WRITER, which writes the fixed mesh,
...
module t2d_flow_thermal_vtkhdf_writer_type
  ...
  type, public :: t2d_flow_thermal_vtkhdf_writer
    private
...
contains
  ...
  subroutine open(this, env, mesh, matl_model, temporal_output, stat, errmsg)
    ...
    class(t2d_flow_thermal_vtkhdf_writer), intent(out) :: this
  ...
  subroutine write_solution(this, time, pressure, velocity, enthalpy, temperature, matl_model, vfrac, &
    ...
    class(t2d_flow_thermal_vtkhdf_writer), intent(inout) :: this
...
end module t2d_flow_thermal_vtkhdf_writer_type
