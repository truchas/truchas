...
The diagnostic [`poiseuille_solid_wall`](../issues/poiseuille_solid_wall.json)
case is an analytic viscous-channel test for the mainline-style representation
in which pure SOLID cells form the walls.  It is kept outside CTest because the
current solid/liquid no-slip discretization places the effective wall at the
solid-cell center, rather than at the material interface.
