...
/*
 * Routine: simulation_data_write_byte(hid_t nsid, const char *dataname, 
                                        int num, const int *size, int8_t *data)  
 ...
 *        
*/
herr_t simulation_data_write_byte(hid_t nsid,
                                 const char * dataname,
                                 int num,
                                 const int *size,
                                 const int8_t *data)
{
    ...
    if ( NULL != ( hsize = DANU_MALLOC(hsize_t,num)) ) {
        ...
        ret_value = danu_data_write_byte(nsid,dataname,num,hsize,data);
...
/*
 * Routine: simulation_data_read_byte(hid_t nsid, const char *dataname, 
                                        int num, const int *size, int8_t *data)  
 ...
 *        
*/
herr_t simulation_data_read_byte(hid_t nsid,
                                 const char * dataname,
                                 int num,
                                 const int *size,
                                 int8_t * data)
{
    ...
    if ( NULL != ( hsize = DANU_MALLOC(hsize_t,num) ) ) {
        ...
        ret_value = danu_data_read_byte(nsid,dataname,num,hsize,data);
