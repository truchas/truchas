...
program main
  ...
  call getNormMoments(dodecahedron, planar_separator, phase_moments_recursive_simplex)
  call getMoments_setMethod(1) ! Half Edge Cutting
  call getNormMoments(dodecahedron, planar_separator, phase_moments_half_edge)
  call getMoments_setMethod(2) ! Iterative Simplex Cutting
  call getNormMoments(dodecahedron, planar_separator, phase_moments_iterative_simplex)
