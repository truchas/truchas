...
#ifndef EXAMPLES_EXAMPLE_ADVECTOR_BASIC_MESH_H_
#define EXAMPLES_EXAMPLE_ADVECTOR_BASIC_MESH_H_
...
class BasicMesh {
 public:
  ...
  BasicMesh(const BasicMesh& other) {
    ...
    std::memcpy(x_m, other.x_m, sizeof(double) * nxo_m + 1);
    std::memcpy(y_m, other.y_m, sizeof(double) * nyo_m + 1);
    std::memcpy(z_m, other.z_m, sizeof(double) * nzo_m + 1);
  }
...
#endif  // EXAMPLES_EXAMPLE_ADVECTOR_BASIC_MESH_H_
