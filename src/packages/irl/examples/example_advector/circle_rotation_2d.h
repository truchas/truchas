...
#ifndef EXAMPLES_EXAMPLE_ADVECTOR_CIRCLE_ROTATION_2D_H_
#define EXAMPLES_EXAMPLE_ADVECTOR_CIRCLE_ROTATION_2D_H_
...
#endif  // EXAMPLES_EXAMPLE_ADVECTOR_CIRCLE_ROTATION_2D_H_
