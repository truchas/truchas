...
#ifndef SRC_C_INTERFACE_GEOMETRY_POLYHEDRONS_C_HEXAHEDRON_H_
#define SRC_C_INTERFACE_GEOMETRY_POLYHEDRONS_C_HEXAHEDRON_H_
...
#endif  // SRC_C_INTERFACE_GEOMETRY_POLYHEDRONS_C_HEXAHEDRON_H_
