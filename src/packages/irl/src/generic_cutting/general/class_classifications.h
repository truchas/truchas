...
#ifndef SRC_GENERIC_CUTTING_GENERAL_CLASS_CLASSIFICATIONS_H_
#define SRC_GENERIC_CUTTING_GENERAL_CLASS_CLASSIFICATIONS_H_

#include "src/generic_cutting/default_cutting_method.h"
#include "src/moments/moments_type_traits.h"
#include "src/planar_reconstruction/planar_reconstruction_type_traits.h"
...
#endif  // SRC_GENERIC_CUTTING_GENERAL_CLASS_CLASSIFICATIONS_H_
