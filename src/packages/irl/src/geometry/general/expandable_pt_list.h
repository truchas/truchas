...
#ifndef SRC_GEOMETRY_GENERAL_EXPANDABLE_PT_LIST_H_
#define SRC_GEOMETRY_GENERAL_EXPANDABLE_PT_LIST_H_
...
class ExpandablePtList {
 ...
 public:
  static constexpr UnsignedIndex_t on_stack_size = 10;
...
#include "src/geometry/general/expandable_pt_list.tpp"

#endif  // SRC_GEOMETRY_GENERAL_EXPANDABLE_PT_LIST_H_
