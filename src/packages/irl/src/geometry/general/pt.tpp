...
#ifndef SRC_GEOMETRY_GENERAL_PT_TPP_
#define SRC_GEOMETRY_GENERAL_PT_TPP_
...
inline Pt Pt::fromEdgeIntersection(const Pt& a_pt_0, const double a_dist_0,
  ...
  const double mu = -a_dist_0 / safelyTiny(a_dist_1 - a_dist_0);
//  IRL::Pt intersection_pt = (1.0 - mu) * a_pt_0;
//  intersection_pt += (mu * a_pt_1);
//  return intersection_pt;
  return a_pt_0 + mu * (a_pt_1 - a_pt_0);
}
