...
static constexpr UnsignedIndex_t complete_block_vertices = 40;
static constexpr UnsignedIndex_t complete_block_faces = 20;
static constexpr UnsignedIndex_t complete_block_half_edges = 80;
}  // namespace default_sizes
}  // namespace half_edge_polytope
...
class HalfEdgePolytope {
 public:
  ...
  void freeVertexAndHalfEdges(VertexType* a_vertex);
  void freeFace(FaceType* a_face);
