...
#ifndef SRC_GEOMETRY_HALF_EDGE_STRUCTURES_SEGMENTED_HALF_EDGE_POLYTOPE_H_
#define SRC_GEOMETRY_HALF_EDGE_STRUCTURES_SEGMENTED_HALF_EDGE_POLYTOPE_H_
...
static constexpr UnsignedIndex_t segemented_max_faces = 50;
static constexpr UnsignedIndex_t segmented_max_vertices = 100;
}  // namespace default_sizes
}  // namespace segmented_half_edge_polytope
...
#include "src/geometry/half_edge_structures/segmented_half_edge_polytope.tpp"

#endif  // SRC_GEOMETRY_HALF_EDGE_STRUCTURES_SEGMENTED_HALF_EDGE_POLYTOPE_H_
