...
#ifndef SRC_GEOMETRY_POLYHEDRONS_OCTAHEDRON_H_
#define SRC_GEOMETRY_POLYHEDRONS_OCTAHEDRON_H_
...
class OctahedronSpecialization: public GeneralPolyhedron<Derived, VertexType, ProxyTet<Derived>> {
public: 
