...
#ifndef SRC_GEOMETRY_POLYHEDRONS_POLYHEDRON_24_TPP_
#define SRC_GEOMETRY_POLYHEDRONS_POLYHEDRON_24_TPP_
...
namespace polyhedron_24_triangulation {
...
Polyhedron24Specialization<Derived, VertexType>::generateHalfEdgeVersion(
    void) const {
...
void Polyhedron24Specialization<Derived, VertexType>::setHalfEdgeVersion(
...
template <class Derived, class VertexType>
constexpr UnsignedIndex_t Polyhedron24Specialization<
    Derived, VertexType>::getNumberOfSimplicesInDecomposition(void) {
  return static_cast<UnsignedIndex_t>(
      polyhedron_24_triangulation::face_triangle_decomposition.size());
}

template <class Derived, class VertexType>
constexpr std::array<UnsignedIndex_t, 4>
Polyhedron24Specialization<Derived, VertexType>::
    getSimplexIndicesFromDecomposition(const UnsignedIndex_t a_tet) {
  assert(a_tet <
         Polyhedron24Specialization::getNumberOfSimplicesInDecomposition());
  return {polyhedron_24_triangulation::face_triangle_decomposition[a_tet][0],
          polyhedron_24_triangulation::face_triangle_decomposition[a_tet][1],
          polyhedron_24_triangulation::face_triangle_decomposition[a_tet][2],
          polyhedron_24_triangulation::datum_index};
}

template <class Derived, class VertexType>
ProxyTet<Derived>
Polyhedron24Specialization<Derived, VertexType>::getSimplexFromDecomposition(
...
template <class Derived, class VertexType>
void Polyhedron24Specialization<Derived, VertexType>::adjustCapToMatchVolume(
...
#endif  // SRC_GEOMETRY_POLYHEDRONS_POLYHEDRON_24_TPP_
