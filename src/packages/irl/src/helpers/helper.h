...
#ifndef SRC_HELPERS_HELPER_H_
#define SRC_HELPERS_HELPER_H_
...
inline void sort3AscendingTracked(double* a_items, int* a_original_index);

/// \brief Sort 3 doubles in an array into descending order via insertion.
/// The original location of the item is also tracked to allow reversing.
inline void sort3DescendingTracked(double* a_items, int* a_original_index);
...
#include "src/helpers/helper.tpp"

#endif  // SRC_HELPERS_HELPER_H_
