...
#ifndef SRC_INTERFACE_RECONSTRUCTION_METHODS_VOLUME_FRACTION_MATCHING_H_
#define SRC_INTERFACE_RECONSTRUCTION_METHODS_VOLUME_FRACTION_MATCHING_H_
...
#include "src/interface_reconstruction_methods/volume_fraction_matching.tpp"

#endif  // SRC_INTERFACE_RECONSTRUCTION_METHODS_VOLUME_FRACTION_MATCHING_H_
