...
#ifndef SRC_INTERFACE_RECONSTRUCTION_METHODS_VOLUME_FRACTION_MATCHING_TPP_
#define SRC_INTERFACE_RECONSTRUCTION_METHODS_VOLUME_FRACTION_MATCHING_TPP_
...
inline void setGroupDistanceToMatchVolumeFraction(
	...
	setGroupDistanceToMatchVolumeFractionPartialFill(a_cell, a_volume_fraction,
												a_reconstruction,
												a_volume_fraction_tolerance);
}
...
inline void setGroupDistanceToMatchVolumeFractionPartialFill(
    ...
    PlanarSeparatorPathGroup* a_reconstruction,
    const double a_volume_fraction_tolerance){
	runIterativeSolverForDistance(a_cell, a_volume_fraction, a_reconstruction, a_volume_fraction_tolerance);
}

}  // namespace IRL

#endif  // SRC_INTERFACE_RECONSTRUCTION_METHODS_VOLUME_FRACTION_MATCHING_TPP_
