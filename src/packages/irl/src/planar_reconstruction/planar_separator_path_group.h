...
#ifndef SRC_PLANAR_RECONSTRUCTION_PLANAR_SEPARATOR_PATH_GROUP_H_
#define SRC_PLANAR_RECONSTRUCTION_PLANAR_SEPARATOR_PATH_GROUP_H_
...
class PlanarSeparatorPathGroup {
 ...
 private:
  ...
  std::unordered_map<UnsignedIndex_t, PlanarSeparatorPath> id_mapping_m;
};

}  // namespace IRL

#include "src/planar_reconstruction/planar_separator_path_group.tpp"

#endif  // SRC_PLANAR_RECONSTRUCTION_PLANAR_SEPARATOR_PATH_GROUP_H_
