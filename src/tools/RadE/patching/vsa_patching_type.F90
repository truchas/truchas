...
!!
!!  RUN() executes the VSA patching algorithm.  At the end of this procedure,
!!    the object's internal data will hold a valid patching of the enclosure.
!!    This procedure must be called after the object is initialized.
!!
