...
module parallel_permutations
  ...
  type, public :: par_perm
    ...
    type(index_map) :: src_ip ! partition descriptor for the src index set
  end type par_perm
...
contains
  ...
  subroutine create_par_perm_1 (this, perm, dest_bsize, src_bsize)
    ...
    call dest_ip%localize_index_array (perm, this%src_ip, this%perm)
...
!      if (.not.this%src_ip%defined()) exit
  ...
  subroutine reorder_r0 (this, dest, src)
    ...
    call this%src_ip%gather_offp(src, src_offP)
