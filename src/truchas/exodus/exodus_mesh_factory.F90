...
module exodus_mesh_factory
  ...
  public :: refine_hex_to_tet !NB: ONLY for create_rect_exodus_mesh
...
!!!! INTERVAL_PARTITION TYPE BOUND PROCEDURES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !! WARNING: This should only be applied to hex meshes generated by
  !! create_rect_exodus_mesh, as it assumes a compatiblity in the orientation
  !! of neighboring hex cells that ensures that shared faces are split in the
  !! same manner. Application to other hex meshes will likely result in spurious
  !! internal interfaces/cracks.
