...
module scalar_func_tools
  ...
  public :: is_const
  public :: alloc_scalar_func_antideriv, alloc_scalar_func_product, alloc_scalar_func_deriv
...
contains
  ...
  subroutine alloc_scalar_func_deriv(f, n, df)
    class(scalar_func), intent(in) :: f
    integer, intent(in) :: n
    class(scalar_func), allocatable, intent(out) :: df
