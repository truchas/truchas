! Modified for use in Truchas, Dec 2020. Original copyright notice follows.
!
!*****************************************************************************************
!
...
!
    function METIS_PartGraphRecursive(nvtxs,ncon,xadj,adjncy,&
        ...
        import idx_t, real_t, METIS_NOPTIONS, c_ptr
        ...
        type(c_ptr), value :: vwgt ! pass C_NULL_PTR or an array matching the following declaration
        ...
        type(c_ptr), value :: vsize ! pass C_NULL_PTR or an array matching the following declaration
        ...
        type(c_ptr), value :: adjwgt ! pass C_NULL_PTR or an array matching the following declaration
        ...
        type(c_ptr), value :: options ! pass C_NULL_PTR or an array matching the following declaration
