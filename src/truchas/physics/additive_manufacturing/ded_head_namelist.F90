...
contains
  ...
  subroutine read_ded_head_namelist (lun)
    ...
    character(31) :: toolpath
    real(r8) :: laser_absorp
    real(r8) :: laser_power, laser_wave_length, laser_waist_radius, laser_beam_param
    namelist /ded_head/ toolpath, laser_absorp, &
        laser_power, laser_wave_length, laser_waist_radius, laser_beam_param
