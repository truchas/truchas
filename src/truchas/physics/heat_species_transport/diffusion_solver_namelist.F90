...
contains
  ...
  subroutine read_diffusion_solver_namelist(lun, ds_sys_type, num_species, params)
    ...
    integer, parameter :: DS_NLK_PC_HYPRE_FSAI = 4
    ...
    integer  :: hypre_fsai_max_steps, hypre_fsai_max_step_size
    real(r8) :: hypre_fsai_kap_tol
    ...
    namelist /diffusion_solver/ max_step_tries, abs_conc_tol, rel_conc_tol, &
        ...
        hypre_fsai_max_steps, hypre_fsai_max_step_size, hypre_fsai_kap_tol, &
    ...
    hypre_fsai_max_steps = NULL_I
    hypre_fsai_max_step_size = NULL_I
    hypre_fsai_kap_tol = NULL_R
    ...
    call broadcast(hypre_fsai_max_steps)
    call broadcast(hypre_fsai_max_step_size)
    call broadcast(hypre_fsai_kap_tol)
    ...
    case ('HYPRE_FSAI')
      ds_nlk_pc = DS_NLK_PC_HYPRE_FSAI
      call plist%set('method', 'FSAI')
    case default
    ...
    if (ds_nlk_pc == DS_NLK_PC_HYPRE_FSAI) then
      if (hypre_fsai_max_steps /= NULL_I) call plist%set('max-steps', hypre_fsai_max_steps)
      if (hypre_fsai_max_step_size /= NULL_I) call plist%set('max-step-size', hypre_fsai_max_step_size)
      if (hypre_fsai_kap_tol /= NULL_I) call plist%set('kap-tol', hypre_fsai_kap_tol)
