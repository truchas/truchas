...
!! DMUMPS_SOLVER_TYPE
!!
!! This module provides an interface to the double-precision direct multifrontal
!! solver in the MUMPS library.
!!
...
contains
  ...
  subroutine init(this, symmetry, stat, verbosity)
    ...
    class(dmumps_solver), intent(out) :: this
  ...
  subroutine setup(this, A, stat)
    ...
    class(dmumps_solver), intent(inout) :: this
    ...
    ! call print_norm2("matrix: ", this%mumps%A_loc)
    ! if (is_iop) print *, this%mumps%nnz
  ...
  ! real(r8) function global_norm2(a)
  !   use parallel_communication
  !   real(r8), intent(in) :: a(:)
  !   global_norm2 = norm2(a)**2
  !   global_norm2 = sqrt(global_sum(global_norm2))
  ! end function global_norm2

  ! subroutine print_norm2(prefix, field)
  !   use parallel_communication, only: is_iop
  !   character(*), intent(in) :: prefix
  !   real(r8), intent(in) :: field(:)
  !   real(r8) :: norm
  !   norm = global_norm2(field)
  !   if (is_iop) print '(a,es14.4)', prefix, norm
  ! end subroutine print_norm2
  ...
  subroutine solve(this, b, x, stat)
    ...
    !call print_norm2("rhs: ", this%mumps%rhs_loc) ! DEBUGGING
    ...
    !call print_norm2("sol: ", this%mumps%sol_loc) ! DEBUGGING
  ...
  subroutine gather_distributed(imap, data_in_gid, data_in, data_out)
    ...
    call MPI_Alltoallv(rsendbuf, sendcounts, sdispls, MPI_REAL8, &
        rrecvbuf, recvcounts, rdispls, MPI_REAL8, comm, ierr)
    ASSERT(ierr == 0)
