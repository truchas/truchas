...
module zmumps_serial_solver_type
...
contains
  ...
  subroutine init(this, symmetry, stat)
    ...
    class(zmumps_serial_solver), intent(out) :: this
  ...
  subroutine setup(this, A, stat)
    ...
    class(zmumps_serial_solver), intent(inout) :: this
...
end module zmumps_serial_solver_type
