...
!! structure used by the thermal/species transport models.
!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!
...
!! used by the thermal/species transport models.  Both structures describe the
!! distribution of materials across the mesh, albeit in different ways.  Note
!! that while the procedures take a general material mesh function as an
!! argument, they necessarily use and modify the MATL module variable from
!! MATL_MODULE.
!!
...
!!    structure.  Note that although the thermal/species transport models do
!!    not alter the material system volume fractions (materials are
!!    conserved), the phase mixture of a multi-phase material will depend on
!!    the current value of the state variables and so the Truchas VoF data,
!!    which is really the volume fraction of phases, will need to be updated,
!!    but only when phase change is possible.
!!
...
contains
 ...
 !! passed to the thermal/species transport models.
 !!
...
! if void is present it is the first material in MMF
 ...
 !! thermal/species transport models do not alter the material volume fractions (materials
