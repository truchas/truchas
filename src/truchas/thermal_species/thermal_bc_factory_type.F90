...
!! boundary condition objects used by the thermal transport model. This factory
...
!! called to create specific boundary condition objects used by the thermal
!! transport model. Each subroutine has output arguments STAT and ERRMSG:
