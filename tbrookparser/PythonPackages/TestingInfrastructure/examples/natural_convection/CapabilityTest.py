...
class CapabilityTest(TruchasCapabilityTest):
    ...
    def testUVelocityProbe(self):
        ...
        VhMax        = self.testdata[0].getProbe(name='VhMax',field='Velocity',timerange=[61001,61002]) 
        #VhMax.str()
    ...
    def testWVelocityProbe(self):
        ...
        VvMax        = self.testdata[0].getProbe(name='VvMax',field='Velocity',timerange=[61001,61002])
        #VvMax.str()
