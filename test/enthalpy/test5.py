...
def run_test(outA, outB):
    ...
    nfail += truchas.compare_max_rel(tempA, tempB, 5e-9, "temperature", outA.time(2))
    ...
    nfail += truchas.compare_max_rel(dataA[:,1], dataB[:,1], 1e-7, 'enthalpy', -1.0)
...
if __name__=="__main__":
    ...
    stdout, out1 = tenv.truchas(1, "3-phase-1.inp", output_dir="test5_out1")
    stdout, out2 = tenv.truchas(1, "3-phase-2.inp", output_dir="test5_out2")
    print("Comparing 3-phase-1 and 3-phase-5")
