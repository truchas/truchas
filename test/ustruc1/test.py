...
class UStrucTest(TruchasTest.GoldenTestCase):
  ...
  def test_final_temp(self):
    '''USTRUC1: verifying the temperature field at the final time'''
    tol = 5.0e-5
  ...
  def test_final_G(self):
    '''USTRUC1: verifying the G field at the final time'''
    tol = 1.0e-4
    test = self.get_test_field('uStruc-G',id=3)
  ...
  def test_final_V(self):
    '''USTRUC1: verifying the V field at the final time'''
    tol = 1.0e-4
    test = self.get_test_field('uStruc-V',id=3)
  ...
  def test_final_L1(self):
    '''USTRUC1: verifying the lambda1 field at the final time'''
    tol = 1.0e-4
    test = self.get_test_field('uStruc-gv1-lambda1',id=3)
  ...
  def test_final_L2(self):
    '''USTRUC1: verifying the lambda2 field at the final time'''
    tol = 1.0e-4
    test = self.get_test_field('uStruc-gv1-lambda2',id=3)
  ...
  def test_final_ustruc(self):
    '''USTRUC1: verifying the microstructure map at the final time'''
    test = self.get_test_field('uStruc-gv1-ustruc',id=3)
